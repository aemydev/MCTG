...
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "[{\"Id\":\"cc8cae97-be23-4b1e-8bf6-5228385aaf8a\",\"Name\":\"Wizard\",\"Description\":\"Wears a pointy hat in which he keeps his enchanted bar of soap. He has to use it every day in order to retain his magical powers\",\"Damage\":25,\"Type\":1,\"ElementType\":0},{\"Id\":\"6271d7b3-2e22-4ced-a7e8-3ddfc5a08125\",\"Name\":\"Orc\",\"Description\":\"They gain their resistance from a thick layer of dirt on their skin, because they never wash themselves\",\"Damage\":25,\"Type\":1,\"ElementType\":0},{\"Id\":\"01626fb0-6133-4360-bb9b-fb1aa71ca09f\",\"Name\":\"Dragon\",\"Description\":\"Known to hoard gold and treasure but if they get too hungry they sometimes snack on some of it\",\"Damage\":50,\"Type\":1,\"ElementType\":2},{\"Id\":\"e2deb4ac-3e72-48f8-8681-ea70b8c6ae02\",\"Name\":\"Kraken\",\"Description\":\"With their many arms they can hold a lot of stuff simultaneously, though due to the lack of fingers they tend to drop whatever they grasp\",\"Damage\":30,\"Type\":1,\"ElementType\":1},{\"Id\":\"87b7ebfe-dbec-4118-ad64-fa5d1347a27b\",\"Name\":\"Fire Elve\",\"Description\":\"Never has to carry a torch, or a lighter for that matter\",\"Damage\":52,\"Type\":0,\"ElementType\":2}]"
echo.																																																																																		 				    
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "[{\"Name\":\"Goblin\",\"Description\":\"Usually seen wearing a loincloth and not much else. Why Exactly they choose this outfit is unknown but they probably just like to feel the breeze\",\"Damage\":15,\"Type\":1,\"ElementType\":0},{\"Name\":\"Knight\",\"Description\":\"While his heavy armor is good at protecting him it does not lend itself to use in water or a racetrack\",\"Damage\":10,\"Type\":1,\"ElementType\":0},{\"Name\":\"Water Spell\",\"Description\":\"Splish Splash\",\"Damage\":20,\"Type\":0,\"ElementType\":1},{\"Name\":\"Fire Spell\",\"Description\":\"Burning\",\"Damage\":40,\"Type\":0,\"ElementType\":2},{\"Name\":\"Kraken\",\"Description\":\"With their many arms they can hold a lot of stuff simultaneously, though due to the lack of fingers they tend to drop whatever they grasp\",\"Damage\":30,\"Type\":1,\"ElementType\":2}]"
echo.																																																																																		 				    
...
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "[{\"Name\":\"Goblin\",\"Description\":\"Description\",\"Damage\":11,\"Type\":1,\"ElementType\":1},{\"Name\":\"Wizard\",\"Description\":\"Description\",\"Damage\":70,\"Type\":1,\"ElementType\":1},{\"Name\":\"Orc\",\"Description\":\"Description\",\"Damage\":22,\"Type\":0,\"ElementType\":1},{\"Name\":\"Knights\",\"Description\":\"Description\",\"Damage\":40,\"Type\":1,\"ElementType\":1},{\"Name\":\"Kraken\",\"Description\":\"Description.\",\"Damage\":28,\"Type\":0,\"ElementType\":0}]"
echo.
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "[{\"Id\":\"0d868225-6ecb-4420-9ed0-60347fa2d603\",\"Name\":\"Normal Spell\",\"Description\":\"...\",\"Damage\":20,\"Type\":0,\"ElementType\":0},{\"Id\":\"38656ea7-8325-4e58-9537-146b0f144a57\",\"Name\":\"FireSpell\",\"Description\":\"Description\",\"Damage\":70,\"Type\":1,\"ElementType\":2},{\"Id\":\"23f74038-90f4-4e37-b30f-03ad8b443b70\",\"Name\":\"Normal Spell\",\"Description\":\"Description\",\"Damage\":22,\"Type\":0,\"ElementType\":1},{\"Id\":\"c6e93c35-f963-43d8-bc19-3015d33bbc76\",\"Name\":\"Dragon\",\"Description\":\"Description\",\"Damage\":40,\"Type\":1,\"ElementType\":1},{\"Id\":\"6036d512-c58b-4a39-bc77-6dc1a51d538a\",\"Name\":\"Fire Elve\",\"Description\":\"Description\",\"Damage\":28,\"Type\":0,\"ElementType\":0}]"
echo.
curl -X POST http://localhost:10001/packages --header "Content-Type: application/json" --header "Authorization: Basic admin-mtcgToken" -d "[{\"Name\":\"Goblin\",\"Description\":\"Usually seen wearing a loincloth and not much else. Why Exactly they choose this outfit is unknown but they probably just like to feel the breeze\",\"Damage\":15,\"Type\":1,\"ElementType\":0},{\"Name\":\"Knight\",\"Description\":\"While his heavy armor is good at protecting him it does not lend itself to use in water or a racetrack\",\"Damage\":10,\"Type\":1,\"ElementType\":0},{\"Name\":\"Water Spell\",\"Description\":\"Splish Splash\",\"Damage\":20,\"Type\":0,\"ElementType\":1},{\"Name\":\"Fire Spell\",\"Description\":\"Burning\",\"Damage\":40,\"Type\":0,\"ElementType\":2},{\"Name\":\"Kraken\",\"Description\":\"With their many arms they can hold a lot of stuff simultaneously, though due to the lack of fingers they tend to drop whatever they grasp\",\"Damage\":30,\"Type\":1,\"ElementType\":2}]"
echo.
echo.
